  ...
  def DivorceLogin(BaseURL: String, appName: String, userType: String) = {
    ...
    .group(s"Divorce_000_${appName}_${userType}_Login") {
      exec(http(s"Login to ${appName} as ${userType}")
        ...
        .check(regex("What language do you want us to use|Enter these details from the letter|You can continue with your divorce|You can now finalise your divorce|You are now divorced")))
    }
